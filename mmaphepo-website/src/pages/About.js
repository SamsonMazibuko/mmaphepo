          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ p: 4, bgcolor: 'transparent', boxShadow: 'none' }}>
              ...
              <form onSubmit={handleSubmit}>
                <Stack spacing={2}>
                  <input type="text" placeholder="Your Name" required style={{ padding: '10px', borderRadius: 4, border: '1px solid #ccc', fontSize: '1rem' }} />
                  <input type="email" placeholder="Your Email" required style={{ padding: '10px', borderRadius: 4, border: '1px solid #ccc', fontSize: '1rem' }} />
                  <textarea placeholder="Your Message" required rows={4} style={{ padding: '10px', borderRadius: 4, border: '1px solid #ccc', fontSize: '1rem', resize: 'vertical' }} />
                  <button type="submit" style={{ background: '#1976d2', color: '#fff', padding: '10px 0', border: 'none', borderRadius: 4, fontWeight: 600, fontSize: '1rem', cursor: 'pointer' }}>Submit</button>
                  {submitted && (
                    <span style={{ color: '#1976d2', fontWeight: 600, marginTop: 8 }}>Thank you for sending us a message, we will get back to you as soon as possible</span>
                  )}
                </Stack>
              </form>
            </Paper>
